...
namespace MVC_AppleLaLa
{
    public class EmailService : IIdentityMessageService
    {
        ...
        {
            string SendGrridSecret = ConfigurationSettings.AppSettings["SendGrridSecret"].ToString();
            // 將您的電子郵件服務外掛到這裡以傳送電子郵件。
            var apiKey = SendGrridSecret;
            var client = new SendGridClient(apiKey);
            var from = new EmailAddress("AppleLaLa@BuildSchool.DK", "AppleLaLa+");
            var subject = "AppleLaLa+ 會員密碼重製確認信";
