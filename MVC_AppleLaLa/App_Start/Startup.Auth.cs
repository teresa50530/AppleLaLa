...
namespace MVC_AppleLaLa
{
    ...
    {
        string FacebookId = ConfigurationSettings.AppSettings["FacebookId"].ToString();
        string FacebookSecret = ConfigurationSettings.AppSettings["FacebookSecret"].ToString();
        string GoogleID = ConfigurationSettings.AppSettings["GoogleId"].ToString();
        string GoogleSecret = ConfigurationSettings.AppSettings["GoogleSecret"].ToString();
